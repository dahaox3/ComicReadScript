...
export type ComicImg = {
	...
	relineUpscaleType?: "wait" | "processing" | "cached" | "show" | "hide" | "error";
};
...
declare const onec: (fn: () => void) => () => void;
...
declare const useStyle: (css: string | Accessor<string>, e?: Element) => void;
export type StyleMap = {
	[P in keyof JSX.CSSProperties]: Accessor<JSX.CSSProperties[P]>;
};
declare const useStyleMemo: (selector: string, styleMapArg: (StyleMap | Accessor<JSX.CSSProperties>)[] | StyleMap, e?: Element) => void;
...
declare namespace helper {
	export { AnimationFrame, FaviconProgress, PQueue, PointerState, ReactiveMap, ReactiveSet, SetStateFunction, StyleMap, UseDrag, UseStore, WakeLock$1 as WakeLock, approx, assign, boolDataVal, byPath, canvasToBlob, clamp, createEffectOn, createEqualsSignal, createMemoMap, createRootEffect, createRootMemo, createScheduled, createThrottleMemo, debounce, descRange, difference, domParse, ensureGmValue, extractRange, fileType, getFileName, getImageData, getKeyboardCode, getMostItem, hijackFn, inRange, isArray, isEqual, isHTMLElement, isImageElement, isNumber, isString, isUrl, keyboardCodeToText, lang, log, mountComponents, needDarkMode, onAutoMount, onUrlChange, onec, plimit, promisifyRequest, querySelector, querySelectorAll, querySelectorClick, range, requestIdleCallback$1 as requestIdleCallback, saveAs, scrollIntoView, setInitLang, setLang, singleThreaded, sleep, t, testImgUrl, throttle, useCache, useDrag, useFaviconProgress, useStore, useStyle, useStyleMemo, versionLt, wait, waitDom, waitImgLoad, waitUrlChange, withEventStop };
}
